                ...
                {promptsLoading ? (
                  ...
                  <>
                    <div>
                      ...
                      <textarea
                        value={customPrompts.descricao}
                        onChange={(e) => updateCustomPrompt('descricao', e.target.value)}
                        rows={8}
                    ...
                    <div>
                      ...
                      <textarea
                        value={customPrompts.titulo}
                        onChange={(e) => updateCustomPrompt('titulo', e.target.value)}
                        rows={6}
                        className="input-dark font-mono text-xs resize-y"
                      />
                    </div>
                    <p className="text-[10px]" style={{ color: 'var(--text-muted)' }}>
                      💾 Clique em "Salvar configurações" para aplicar os prompts personalizados.
                    </p>
                  </>
                ) : null}
              </div>
